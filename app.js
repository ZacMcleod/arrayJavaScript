...
console.log(`italianFood from problemThree's filter: `, italianFood)
...
let idServingsFood = problemFour();
console.log(`idServingsFood from problemFour's filter: `, idServingsFood)
...
function problemSeven(){
    let results;
    choiceIngredient = prompt("Which ingredient would you like in the food?")
    results = dishes.filter(function(el){
...
//let choiceIngredientFood = problemSeven();
//console.log(`chickpeaFood from problemSeven's filter: `, choiceIngredientFood)
